  ...
  return (
    <div className='w-full h-full flex flex-col items-center'>
      <form
        ...
        onSubmit={sendReport}
      >
        <h1 className='text-xl p-3 w-full border-b-2 border-indigo-600 bg-gradient-to-t from-violet-400 to-indigo-400 text-white'>From: {userSession.user.userName} ({userSession.user.email})</h1>
        <textarea
          name='content'
